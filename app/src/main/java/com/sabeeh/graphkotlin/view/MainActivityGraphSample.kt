...
import com.sabeeh.graphkotlin.model.AnimalModel
import com.sabeeh.graphkotlin.model.DatabaseHandler


class MainActivityGraphSample : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_graph_sample)
    ...
    fun saveAnimals() {
        ...
        val record2 = databaseHandler.addAnimalDetails(AnimalModel(2, "Impala", 1079, 10, 90))
        val record3 = databaseHandler.addAnimalDetails(AnimalModel(3, "Leopard", 570, 13, 89))
        val record4 = databaseHandler.addAnimalDetails(AnimalModel(4, "Crocodile", 450, 30, 66))
        val record5 = databaseHandler.addAnimalDetails(AnimalModel(5, "Dog", 650, 14, 78))
        val record6 = databaseHandler.addAnimalDetails(AnimalModel(6, "Mouse", 815, 20, 62))
    }
